hangman: ./obj/main.o ./obj/risunok.o ./obj/random.o ./obj/input.o ./obj/asteriks.o ./obj/jizi.o
	gcc -o hangman ./obj/main.o ./obj/risunok.o ./obj/jizi.o ./obj/random.o ./obj/asteriks.o ./obj/input.o -lncursesw
